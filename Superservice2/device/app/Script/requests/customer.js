function CheckParamsFilling(sender, cust, pr){
	...
	res = q.ExecuteCount();
	if (res > 0 && cust.FinDirExist != DB.EmptyRef("Enum_LogicType") && cust.PeapleCount != DB.EmptyRef("Enum_PeopleCountVarint")){
		Workflow.Action("GoForward",[pr]);
	} else {
